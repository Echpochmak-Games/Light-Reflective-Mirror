...
namespace kcp2k
{
    public class KcpTransport : Transport
    {
        ...
        //Calculated Max (based on Receive Window Size)
        ...
        //KCP unreliable channel max message size for convenience. Not changeable.
        ...
        static KcpChannel ToKcpChannel(int channel) =>
            channel == 0 ? KcpChannel.Reliable : KcpChannel.Unreliable;
